...
from src.core.validators import validate_profile_names_are_only_letters, validate_profile_age, \
...
class Profile(models.Model):
    ...
    email = models.EmailField(blank=True, validators=[MaxLengthValidator(15), EmailValidator, validate_email_ending])
